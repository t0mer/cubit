...
// startup so a bad key is a configuration error, not a first-login surprise.
...
// decrypt opens a nonce||ciphertext||tag blob produced by encrypt. It fails on
// the wrong key and on any tampering, because GCM authenticates the ciphertext.
